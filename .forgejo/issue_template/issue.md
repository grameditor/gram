...
- If you want to make a feature request or have an idea for improvements, please
  ...
  [wiki](https://codeberg.org/GramEditor/gram/wiki/Feature-Requests) instead of
  opening an issue.

- If you have a question about how the software works or how to configure it,
  check the [wiki Guides](https://codeberg.org/GramEditor/gram/wiki/Guides) or
the [documentation](https://gram-editor.com/docs/), or join the [XMPP
chat](https://slidge.im/gram/#/guest?join=gram@rooms.slidge.im) and ask there
...
can in the issue. See the guide to [debugging
crashes](https://gram-editor.com/docs/development/debugging-crashes/) for more
information on retrieving logs or using a debugger with Gram.
