...
use core_foundation::{
    array::{
        CFArray, CFArrayAppendValue, CFArrayCreateMutable, CFArrayRef, CFMutableArrayRef,
        kCFTypeArrayCallBacks,
    },
    attributed_string::CFMutableAttributedString,
    base::{CFRange, CFRelease, TCFType, kCFAllocatorDefault},
    dictionary::{
...
use core_text::{
    ...
    font_descriptor::{
        ...
        kCTFontFeatureSettingsAttribute, kCTFontSlantTrait, kCTFontSymbolicTrait,
